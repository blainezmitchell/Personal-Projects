...
I chose this project because I loved the idea of using networking concepts tocreate a fun, real-time
game. I wasn't sure what kind of game I wanted to make, as I wanted it to be simple enough that I could
feasibly implement it as a first projet but also complicated enough to be challenging and force me to use
